...
const content = [
  ...
  buildTable(
    ...
    [
      ...
      ["TOLL_CAPACITY_PAYMENT_PER_KW_MONTH", "$8/kW-mo", "SELLER-SIDE market rate (RFP didn't specify). $4.8M for 6 months at 100 MW. Directly anchored to the PJM 2025/26 capacity-auction clearing price of $269.92/MW-day = $8.10/kW-mo (Jul 2024 auction, ~10× higher than 2024/25 amid AI-load growth). For comparison: ERCOT 2024 CONE for SCGT ≈ $24.42/kW-mo (Brattle), Norton Rose Fulbright Aug 2025 industry view $30–$50/kW-mo for new-build gas. ERCOT lacks a formal capacity market so PJM is an imperfect benchmark; $8 plausibly tracks a Houston SCGT operator's foregone scarcity revenue. Buyer-side gross toll value ~$1.1–1.4M / 6mo (this model + ltemry independent cross-check at $1.42M), so the default seller's ask doesn't clear by ~4×."],
    ],
    [3000, 1500, 4860],
  ),
  ...
  BULLET_R(
    ...
    " — TOLL_CAPACITY_PAYMENT_PER_KW_MONTH defaults to $8/kW-mo (SELLER-SIDE market rate). Directly anchored to PJM's 2025/26 capacity-auction clearing price of $269.92/MW-day = $8.10/kW-mo (Jul 2024 auction). For comparison: ERCOT 2024 CONE for SCGT ≈ $24.42/kW-mo (Brattle), Norton Rose Fulbright Aug 2025 industry view $30–$50/kW-mo for new-build gas. ERCOT has no formal capacity market so PJM is an imperfect comp; $8 plausibly tracks a Houston SCGT operator's foregone scarcity revenue. The buyer's MW reservation is a model parameter (Scenario.toll_mw_reserved): the LP caps g_toll at the reserved MW and the capacity payment scales linearly. Two sweeps in power_procurement_sweep.py: --capacity-payment-sweep varies K at fixed 100 MW (finds K* ≈ $2/kW-mo across our 4 drift scenarios); --reservation-sweep solves the LP at MW ∈ {0, 20, 40, 60, 80, 100} so the buyer's ex-ante optimal reservation can be picked at any K. Cross-check against ltemry/FTG-Final-Project independently places toll's gross value at $1.42M / 6mo, well below $4.8M at default seller rate × 100 MW.",
  ),
  BULLET_R(
